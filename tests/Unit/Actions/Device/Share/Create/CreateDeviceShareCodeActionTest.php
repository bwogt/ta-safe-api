...
namespace Tests\Unit\Actions\Device\Share\Create;
...
final class CreateDeviceShareCodeActionTest extends CreateDeviceShareCodeActionTestSetUp
{
    ...
    public function test_should_throw_exception_when_user_is_not_device_owner(): void
    {
        ...
        try {
            (new CreateDeviceShareCodeAction)($user, $this->device);
    ...
    public function test_should_throw_exception_when_device_status_is_pending(): void
    {
        ...
        try {
            (new CreateDeviceShareCodeAction)($this->user, $device);
    ...
    public function test_should_throw_domain_exception_when_redis_fails_during_validation(): void
    {
        ...
        $this->expectException(CreateDeviceShareCodeException::class);
        (new CreateDeviceShareCodeAction)($this->user, $this->device);
    }
    ...
    public function test_should_throw_domain_exception_when_max_generation_attempts_reached(): void
    {
        ...
        try {
            (new CreateDeviceShareCodeAction)($this->user, $this->device);
            $this->fail('Expected CreateDeviceShareCodeException was not thrown.');
        } catch (CreateDeviceShareCodeException $e) {
